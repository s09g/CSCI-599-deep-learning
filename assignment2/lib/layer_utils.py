...
class VanillaRNN(object):
	...
	def step_forward(self, x, prev_h):
		...
		############################################################################
		# check out the one step forward pass implementation			 	   #
		############################################################################
		# Wx, Wh, b = self.params[self.wx_name], self.params[self.wh_name], self.params[self.wh_name.self.b_name]
		# image_term = x.dot(Wx)
	...
	def step_backward(self, dnext_h, meta):
		...
		#############################################################################
		# check out the one step backward pass implementation				    #
		#############################################################################
	...
	def forward(self, x, h0):
		...
		self.meta = []
		##############################################################################
		# Check forward pass for a vanilla RNN running on a sequence of		 #
	...
	def backward(self, dh):
		...
		##############################################################################
		# Check the backward pass for a vanilla RNN running an entire			 #
...
class word_embedding(object):
	...
	def forward(self, x):
		...
		##############################################################################
		#  Check the forward pass for word embeddings.							 #
		#																			 #
	...
	def backward(self, dout):
		...
		self.grads[self.w_name] = None
		##############################################################################
		#  Check the backward pass for word embeddings.					 	 #
		#																			 #
...
class temporal_fc(object):
	...
	def forward(self, x):
		...
		"""
		##############################################################################
		#  Check the forward pass for temporal fully connected layer.		     #
		##############################################################################
		N, T, D = x.shape
	...
	def backward(self, dout):
		...
		M = self.params[self.b_name].shape[0]
		##############################################################################
		# Check the backward pass for temporal fully connected layer.		     #
		##############################################################################
...
class temporal_softmax_loss(object):
	...
	def forward(self, feat, label, mask):
		...
		N, T, V = feat.shape
		##############################################################################
		# Check the forward pass for temporal softmax loss layer.			     #
		##############################################################################
	...
	def backward(self):
		...
		##############################################################################
		#  Check the backward pass for temporal softmax loss layer.			 #
		##############################################################################
